...
function Register() {
  ...
  return (
    <div className="RegisterPage" style={{ backgroundSize: 'cover', backgroundImage: 'url(http://localhost/t.png)', minHeight: '100vh', display: 'flex', justifyContent: 'center', alignItems: 'center', background: ' #f3f3f3' }}>
      ...
      <div className="RegisterContainer">
        ...
        <form className="RegisterForm" onSubmit={save}>
          ...
          <Typography className="RegisterLink">
            Already Have Account? <Link to="/login" className="RegisterSignInLink">Sign In</Link>
          </Typography>
          <Typography className="RegisterLink">
            Or <Link to="/google-login" className="RegisterGoogleLink">Sign Up with Google</Link>
          </Typography>
        </form>
      </div>
    </div>
