...
const LogIn = () => {
  ...
  return (
    <div className="login-container" style={{ backgroundSize: 'cover', backgroundImage: 'url(http://localhost/t.png)', height: '100vh', display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
